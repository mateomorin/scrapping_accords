...
1. **Legifrance scraping** ([`src/legifrance`](src/legifrance) - [`LEGIFRANCE.md`](src/legifrance/LEGIFRANCE.md)): using LegiFrance API to get all the data
2. **Data conversion** ([`src/data_conversion`](src/data_conversion) - [`DATA_CONVERSION.md`](src/data_conversion/DATA_CONVERSION.md)): converting Word documents (scraped from LégiFrance) to Markdown thanks to different tools (and LLMs for OCR).
